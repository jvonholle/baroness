...
testmini: tests/minimax_test.cpp
	g++ -std=c++11 tests/minimax_test.cpp src/minimax.cpp src/minimax.h src/nnet.h src/nnet.cpp src/movement.h src/movement.cpp -o baroness
#Play checkers
train: src/train.cpp
...
trainop: src/train.cpp
	g++ -O3 -Ofast -std=c++11 src/movement.cpp src/movement.h src/nnet.cpp src/nnet.h src/player.cpp src/player.h src/tourney.cpp src/tourney.h src/train.cpp src/minimax.cpp src/minimax.h -o baroness
